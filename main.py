...
async def websocket_nifty50(websocket: WebSocket):
    await websocket.accept()

    nifty50_instrument_keys = [
        "NSE_EQ|INE467B01029",  # ADANIENT
        "NSE_EQ|INE123W01016", # ADANIGREEN
        # ... (add all 50 instrument keys)
    ]

    # This is a placeholder for the Upstox WebSocket connection
    # In a real implementation, you would connect to the Upstox WebSocket
    # and subscribe to the instrument keys.

    while True:
        # In a real implementation, you would receive data from the Upstox WebSocket
        # and send it to the frontend.

        # For now, we'll just send some mock data
        data = {
            "symbol": "ADANIENT",
            "price": 1000,
            "change_percent": 0.5
